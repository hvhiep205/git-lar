    ...
    <div id="header">
        ...
        <div class="header-body">
            <div class="container beta-relative">
                <div class="pull-left">
                    <a href="index.html" id="logo"><img src="{{ asset('source/assets/dest/images/logo-cake.png') }}"
                            width="200px" alt=""></a>
                </div>
                        ...
                        <div class="cart">
                            ...
                            <div class="beta-dropdown cart-body">
                                <div class="cart-item">
                                    <div class="media">
                                        <a class="pull-left" href="#"><img
                                                src="{{ asset('source/assets/dest/images/products/cart/1.png') }}"
                                                alt=""></a>
                                        <div class="media-body">
                                            <span class="cart-item-title">Sample Woman Top</span><span
                                                class="cart-item-options">Size: XS; Colar: Navy</span>
                                ...
                                <div class="cart-item">
                                    <div class="media">
                                        <a class="pull-left" href="#"><img
                                                src="{{ asset('source/assets/dest/images/products/cart/2.png') }}"
                                                alt=""></a>
                                        <div class="media-body">
                                ...
                                <div class="cart-item">
                                    <div class="media">
                                        <a class="pull-left" href="#"><img
                                                src="{{ asset('source/assets/dest/images/products/cart/3.png') }}"
                                                alt=""></a>
                                        <div class="media-body">
                                            <span class="cart-item-title">Sample Woman Top</span>
                                            <span class="cart-item-options">Size: XS; Colar: Navy</span>
                            ...
                            <div class="row">
                                    ...
                                    <div class="single-item">
                                        <div class="single-item-header">
                                            <a href="product.html"><img
                                                    src="{{ asset('source/assets/dest/images/products/1.jpg') }}"
                                                    alt=""></a>
                                        </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="single-item">
                                        ...
                                        <div class="single-item-header">
                                            <a href="product.html"><img
                                                    src="{{ asset('source/assets/dest/images/products/2.jpg') }}"
                                                    alt=""></a>
                                        </div>
                                        <div class="single-item-body">
                                            <p class="single-item-title">Sample Woman Top</p>
                                ...
                                <div class="col-sm-3">
                                    <div class="single-item">
                                        <div class="single-item-header">
                                            <a href="product.html"><img
                                                    src="{{ asset('source/assets/dest/images/products/3.jpg') }}"
                                                    alt=""></a>
                                        </div>
                                        <div class="single-item-body">
                                            <p class="single-item-title">Sample Woman Top</p>
                    ...
                    <div class="col-sm-4">
                        <div class="col-sm-10">
                            <div class="widget">
                                ...
                                <div>
                                    <div class="contact-info"><i class="fa fa-map-marker"></i>
